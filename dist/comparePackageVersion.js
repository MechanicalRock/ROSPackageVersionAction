...
const extractPackageVersionFromMaster_1 = require("./extractPackageVersionFromMaster");
...
() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return versionFromBranch !== versionFromMaster
        ? core.setFailed("Action failed due to the difference of package version between main and the branch.")
        : true;
});
